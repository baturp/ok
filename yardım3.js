...
let images = ['https://i.hizliresim.com/T5hT8C.gif', 'https://i.hizliresim.com/T5hT8C.gif'];
message.channel.send(new Discord.MessageEmbed().setColor('#000001').setDescription(`**Yardım 3 Menüsüne Hoş Geldin Dostum 😇**
\`\`\`${client.user.username} Kullanırken @HoXy BoT rolünü en yukarıda tutunuz.\`\`\`
...
**`).setThumbnail(message.author.avatarURL() ? message.author.avatarURL({dynamic: true}) : 'https://i.hizliresim.com/T5hT8C.gif').setImage(images.random()))
